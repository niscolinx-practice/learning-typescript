...
},{"./View":"views/View.ts"}],"views/CollectionView.ts":[function(require,module,exports) {
"use strict";
...
},{}],"views/UserList.ts":[function(require,module,exports) {
"use strict";
...
var _CollectionView2 = require("./CollectionView");
...
var UserList =
/*#__PURE__*/
function (_CollectionView) {
  _inherits(UserList, _CollectionView);
...
},{"./UserShow":"views/UserShow.ts","./CollectionView":"views/CollectionView.ts"}],"../../node_modules/axios/lib/helpers/bind.js":[function(require,module,exports) {
'use strict';
...
var ApiSync = function ApiSync(rootUrl) {
  ...
  this.save = function (data) {
    ...
    if (id) {
      return _index.default.put("".concat(_this.rootUrl, "/").concat(id), data);
    } else {
      return _index.default.post(_this.rootUrl, data);
    }
  };

  this.fetch = function (id) {
    return _index.default.get("".concat(_this.rootUrl, "/").concat(id));
  };
};

exports.ApiSync = ApiSync;
},{"../../../node_modules/axios/index":"../../node_modules/axios/index.js"}],"models/Model.ts":[function(require,module,exports) {
"use strict";
...
if ((!parent || !parent.isParcelRequire) && typeof WebSocket !== 'undefined') {
  ...
  var ws = new WebSocket(protocol + '://' + hostname + ':' + "42635" + '/');
