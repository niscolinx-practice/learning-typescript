  ...
  _createClass(User, [{
    ...
    value: function save() {
      ...
      if (id) {
        ...
        axios_1.default.post(URL, this.data).then(function (res) {
          return console.log(res);
        }).catch(function (err) {
          return console.log(err);
        });
    ...
    value: function fetch() {
      ...
      axios_1.default.get(URL + this.get('id')).then(function (res) {
        _this.set(res.data);
      }).catch(function (err) {
        throw new Error(err);
      });
...
exports.User = User;
},{"axios":"../node_modules/axios/index.js","./Events":"models/Events.ts"}],"index.ts":[function(require,module,exports) {
"use strict";
