...
var ApiSync = function ApiSync(rootUrl) {
  ...
  this.save = function (data) {
    ...
    if (id) {
      return _axios.default.put("".concat(_this.rootUrl, "/").concat(id), data);
    } else {
      return _axios.default.post(_this.rootUrl, data);
    }
  };

  this.fetch = function (id) {
    return _axios.default.get("".concat(_this.rootUrl, "/").concat(id));
  };
};
