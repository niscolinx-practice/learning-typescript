...
},{"./lib/axios":"../node_modules/axios/lib/axios.js"}],"User.ts":[function(require,module,exports) {
"use strict";
...
function () {
  ...
  _createClass(User, [{
    ...
    value: function fetch() {
      axios_1.default.get('http://localhost:3000/users/' + localStorage.getItem('id')).then(function (res) {
        console.log(res);
      }).catch(function (err) {
        throw new Error(err);
      });
