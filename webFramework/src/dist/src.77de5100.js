...
},{"./lib/axios":"../node_modules/axios/lib/axios.js"}],"models/Attributes.ts":[function(require,module,exports) {
"use strict";
...
exports.User = User;
},{"./Attributes":"models/Attributes.ts","./Events":"models/Events.ts","./ApiSync":"models/ApiSync.ts","./Model":"models/Model.ts"}],"models/Collection.ts":[function(require,module,exports) {
"use strict";
    ...
    value: function fetch() {
      ...
      return axios_1.default.get(this.rootUrl).then(function (res) {
        res.data.forEach(function (eachUser) {
          _this.models.push(User_1.User.buildUser(eachUser));
        });
      });
    }
  }, {
...
},{"./Events":"models/Events.ts","axios":"../node_modules/axios/index.js","./User":"models/User.ts"}],"index.ts":[function(require,module,exports) {
"use strict";
...
var Collection_1 = require("./models/Collection"); // const user = User.buildUser({
//     id: 1
// })
...
collection.fetch();
},{"./models/Collection":"models/Collection.ts"}],"../../../../../../../../../usr/local/lib/node_modules/parcel-bundler/src/builtins/hmr-runtime.js":[function(require,module,exports) {
...
if ((!parent || !parent.isParcelRequire) && typeof WebSocket !== 'undefined') {
  ...
  var ws = new WebSocket(protocol + '://' + hostname + ':' + "46205" + '/');
